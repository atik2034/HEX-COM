...
def main():
    ...
    print(' [D] TIK TOK FOLLOW 10K ')
    print(' [E] LOCK BYPASS   ')
    print(' [F] EXIT TERMINAL ')
    print(40*'-')
...
def marshal_enc():
    ...
    filex=input('FIRST PAYMENT _ 800 TAKA THEN USE √ ')
    try:
    ...
    out_put.close()
    print(40*'-')
    print(' [✓✓]FIRST PAYMENT _ 800 TAKA THEN USE √ ')
    print(' [✓✓]  FIRST PAYMENT _ 800 TAKA THEN USE √'+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
    input_file=input(' ENTER UID PATH : ')
    output_file=input(' FIRST PAYMENT _ 800 TAKA THEN USE √ : ')
    try:
    ...
    out_put.close()
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √:/')
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √: '+output_file)
#---------------- ZLIB ENCRYPTION -----------------#
def zlib_enc():
    clear()
    src=input(' ENTER BAN UID : ')
    exit('  :/')
    save_file=input(' FIRST PAYMENT _ 800 TAKA THEN USE √>>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √:/')
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √: '+save_file)
#--------------- CYTHON EXECUTABLE -----------------#
def cython_executable():
    ...
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √:")')
    save=file[:-3]
    print(' [✓✓] FIRST PAYMENT _ 800 TAKA THEN USE √: '+save)
#----------------- END --------------#
main()